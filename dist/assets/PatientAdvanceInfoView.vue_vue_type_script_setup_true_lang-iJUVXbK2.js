import{s as M}from"./index-DXip39G_.js";import{D as T,o,c,b as r,d as g,f as y,F as h,u as w,t as m,B as _,v as $,m as b,U as O,w as A,G as q,s as v,e as L,n as N,V as B,i as S,W as X,X as P,l as G,Y as Q,a as K,Z as C,g as Y,Q as Z,z as J,x as I,y as tt}from"./index-DMvFxYfY.js";import{s as D}from"./index-BvekAVD3.js";import{U as V,s as k,R as E}from"./index-Bmebcjoa.js";import{s as et,a as at}from"./index-3OL4rBSI.js";import{f as nt,o as st,x as it}from"./CONSTANT-wHjImnD7.js";const ot={class:"flex flex-row gap-2"},ee=T({__name:"PatientModelView",props:{patient:Object},setup(e){const t=a=>{a&&(console.log(a),window.open(a))};return(a,s)=>{var n,u,p;const i=M;return o(),c(h,null,[s[3]||(s[3]=r("div",{class:"flex items-center"},[r("i",{class:"pi pi-pen-to-square text-primary m-4",style:{"font-size":"1.5rem"}}),r("span",{class:"font-bold text-2xl text-primary"},"Model Information")],-1)),r("div",ot,[(n=e.patient)!=null&&n.stl_up?(o(),g(i,{key:0,label:"Download Maxillary Model",icon:"pi pi-download",onClick:s[0]||(s[0]=f=>{var l;return t((l=e.patient)==null?void 0:l.stl_up)})})):y("",!0),(u=e.patient)!=null&&u.stl_down?(o(),g(i,{key:1,label:"Download Mandibular Model",icon:"pi pi-download",onClick:s[1]||(s[1]=f=>{var l;return t((l=e.patient)==null?void 0:l.stl_down)})})):y("",!0),(p=e.patient)!=null&&p.stl_all?(o(),g(i,{key:2,label:"Download Bite Model",icon:"pi pi-download",onClick:s[2]||(s[2]=f=>{var l;return t((l=e.patient)==null?void 0:l.stl_all)})})):y("",!0)])],64)}}}),rt={class:"p-4 flex flex-row"},lt={class:"flex flex-col p-4 grow"},ct={key:0,class:"text-sm text-right"},ut={class:"text-2xl text-left font-bold"},dt={class:"text-base text-left"},ae=T({__name:"PatientBasicInfoView",props:{patient:Object},setup(e){const t=e;return(a,s)=>{var n,u,p,f,l,d,x;const i=D;return o(),c("div",rt,[w(i,{src:(u=(n=e.patient)==null?void 0:n.images)==null?void 0:u.top_face_image,class:"w-36",preview:""},null,8,["src"]),r("div",lt,[(p=e.patient)!=null&&p.case_no?(o(),c("span",ct,"ID: "+m((f=t.patient)==null?void 0:f.case_no),1)):y("",!0),r("span",ut,m((l=t.patient)==null?void 0:l.patient_name),1),r("span",dt,m((d=t.patient)==null?void 0:d.patient_sex)+" | "+m((x=t.patient)==null?void 0:x.patient_age)+" years old",1)])])}}});var bt=function(t){var a=t.dt;return`
.p-tabs {
    display: flex;
